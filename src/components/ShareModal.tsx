  ...
  return (
    <AnimatePresence>
      {activeModal === "share" && (
        ...
        >
          <motion.div
            className="bg-casino-deep-blue/80 w-full max-w-xl max-h-[90vh] rounded-lg border border-casino-light-blue p-8 modal-container overflow-y-auto"
            ...
            >
              <div className="flex items-center justify-between gap-2 bg-casino-light-blue border border-casino-light-blue rounded-lg px-4 py-2">
                <input
                  ...
                  value={link}
                  readOnly
                  className="bg-transparent max-w-60 outline-none text-casino-silver font-semibold"
                />
                <Button
                  onClick={handleCopy}
                  variant="outline"
